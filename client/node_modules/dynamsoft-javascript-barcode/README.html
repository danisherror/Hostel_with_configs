...
<ul>
<li>Hello World - <a href="#hello-world---simplest-implementation">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/1.hello-world/1.hello-world.html">Github</a></li>
<li>Angular App - <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/helloworld-angular.html?ver=9.6.40&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/1.hello-world/3.read-video-angular">Github</a></li>
<li>React App - <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/helloworld-reactjs.html?ver=9.6.40&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/1.hello-world/4.read-video-react">Github</a></li>
<li>Vue App - <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/helloworld-vuejsv3.html?ver=9.6.40&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/1.hello-world/6.read-video-vue3">Github</a></li>
<li>PWA App - <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/helloworld-pwa.html?ver=9.6.40&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/1.hello-world/10.read-video-pwa">Github</a></li>
<li>WebView in Android and iOS - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/v9.6.40/1.hello-world/14.read-video-webview">Github</a></li>
<li>Read Driver Licenses - <a href="https://www.dynamsoft.com/barcode-reader/docs/core/programming/usecases/scan-and-parse-AAMVA.html?ver=9.6.40&utm_source=npm&&lang=js">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/4.use-case/2.read-a-drivers-license.html">Github</a></li>
<li>Fill A Form - <a href="https://www.dynamsoft.com/barcode-reader/docs/core/programming/usecases/scan-barcodes-as-input.html?lang=js&&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/4.use-case/1.fill-a-form-with-barcode-reading.html">Github</a></li>
<li>Show result information on the video - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/main/4.use-case/3.show-result-texts-on-the-video.html">Github</a></li>
<li>Debug Camera and Collect Video Frame - <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/debug.html?lang=js&&utm_source=npm">Guide</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/blob/v9.6.40/5.others/debug">Github</a></li>
</ul>
<p>You can also:</p>
<ul>
<li>Try the Official Demo - <a href="https://demo.dynamsoft.com/barcode-reader-js/?ver=9.6.40&utm_source=npm">Run</a> | <a href="https://github.com/Dynamsoft/barcode-reader-javascript-demo/">Github</a></li>
<li>Try Online Examples - <a href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/v9.6.40/">Github</a></li>
</ul>
...
<span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-javascript-barcode@9.6.40/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
        <span class="hljs-comment">// Specifies a license, you can visit https://www.dynamsoft.com/customer/license/trialLicense?ver=9.6.40&amp;utm_source=npm&amp;product=dbr&amp;package=js to get your own trial license good for 30 days. </span>
...
<p align="center" style="text-align:center; white-space: normal; ">
  ...
  <!--
  &nbsp;
  <a target="_blank" href="https://demo.dynamsoft.com/Samples/DBR/JS/1.hello-world/1.hello-world.html?ver=9.6.40&utm_source=npm" title="Run in Dynamsoft" style="text-decoration:none;">
...
<p>You can run the example deployed to <a target="_blank" href="https://demo.dynamsoft.com/Samples/DBR/JS/1.hello-world/1.hello-world.html?ver=9.6.40&utm_source=npm" title="Run in Dynamsoft">the Dynamsoft Demo Server</a> or test it with <a target="_blank" href="https://jsfiddle.net/DynamsoftTeam/pL4e7yrd/" title="Run in JSFiddle">JSFiddle code editor</a>. You will be asked to allow access to your camera, after which the video will be displayed on the page. After that, you can point the camera at a barcode to read it.</p>
...
<p>If the test doesn't go as expected, you can <a href="https://www.dynamsoft.com/contact/?ver=9.6.40&utm_source=npm">contact us</a>.</p>
...
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-javascript-barcode@9.6.40/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
<ul>
<li>UNPKG  </li>
</ul>
<pre><code class="hljs html language-html">  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/dynamsoft-javascript-barcode@9.6.40/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
...
<p><a target="_blank" href="https://www.dynamsoft.com/barcode-reader/downloads/?ver=9.6.40&utm_source=npm" title="Download the JavaScript Package">Download the JavaScript Package</a></p></li>
<li><p>yarn</p></li>
</ul>
...
<pre><code class="hljs html language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/dynamsoft-barcode-reader-js-9.6.40/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
<p>or</p>
<pre><code class="hljs html language-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"/node_modules/dynamsoft-javascript-barcode/dist/dbr.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
<p>or</p>
<pre><code class="hljs typescript language-typescript"><span class="hljs-keyword">import</span> { BarcodeScanner } <span class="hljs-keyword">from</span> <span class="hljs-string">'dynamsoft-javascript-barcode'</span>;
</code></pre>
...
<p>To test the SDK, you can request a 30-day trial license via the <a href="https://www.dynamsoft.com/customer/license/trialLicense?ver=9.6.40&utm_source=npm&product=dbr&package=js">customer portal</a>.</p>
<blockquote>
...
Dynamsoft.DBR.BarcodeScanner.engineResourcePath = <span class="hljs-string">"https://cdn.jsdelivr.net/npm/dynamsoft-javascript-barcode@9.6.40/dist/"</span>;
</code></pre>
...
<p>See also <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/samples-demos/parameter-settings.html?ver=9.6.40&utm_source=npm">settings samples</a>.</p>
<blockquote>
  <p>Find the full list of the runtime settings <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/global-interfaces.html?ver=9.6.40&utm_source=npm&&ver=latest#runtimesettings" target="_blank" title="here">here</a>.</p>
</blockquote>
...
<blockquote>
  <p>Generally, you need to provide a resolution that the camera supports. However, in case a camera does not support the specified resolution, it usually uses the closest supported resolution. As a result, the selected resolution may not be the actual resolution. In this case, add an option with the class name <code>dce-opt-gotResolution</code> (as shown above) and the SDK will automatically use it to show the <strong>actual resolution</strong>.</p>
</blockquote>
...
<a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/?ver=9.6.40">https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/?ver=9.6.40</a>.</p>
...
<p>This API is only required for in-browser video streaming. If a browser does not support this API, the <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/api-reference/BarcodeScanner.html?ver=9.6.40&utm_source=npm#singleframemode">Single Frame Mode</a> will be used automatically. If the API exists but doesn't work correctly, the Single Frame Mode can be used as an alternative way to access the camera.</p></li>
...
<p>If you want to upgrade the SDK from an old version to a newer one, please see <a href="https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/upgrade-guide/?ver=9.6.40&utm_source=npm">how to upgrade</a>.</p>

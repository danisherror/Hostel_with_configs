                ...
                <form action="#">
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        type="text"
                        value={inpval.phone} onChange={setdata} name="phone"
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        className="w-full rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                        type="email"
                        value={inpval.email} onChange={setdata} name="email"
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text"
                      value={inpval.collegeid} onChange={setdata} name="collegeid"
                      placeholder="1MS20CS037"
                      defaultValue="1MS20CS037"
                    />
                  </div>
                  <div className="mb-5.5">
                    <label
                    ...
                    <input
                      className="w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                      type="text"
                      value={inpval.semester} onChange={setdata} name="semester"
                      placeholder="4"
                      defaultValue="4"
                    />
                  </div>
